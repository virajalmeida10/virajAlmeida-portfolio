  ...
  return (
    <section id="about" className="about-section" aria-label="About Viraj Almeida">
      ...
      <div className="about-header fade-in-up delay-1">
        <img className="about-avatar" src={profilePhoto} alt="Viraj Almeida" loading="lazy" />
        <h2 className="section-title">Software Engineer building production-grade systems.</h2>
      </div>

      <div className="about-body fade-in-up delay-2">
      ...
      <div className="spec-strip fade-in-up delay-3" role="list" aria-label="Key metrics">
        {specs.map((s) => (
